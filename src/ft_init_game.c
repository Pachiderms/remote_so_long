...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/15 13:26:55 by tzizi            #+#    #+#             */
/*   Updated: 2024/08/15 13:26:55 by tzizi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_sprites(t_game *game)
{
	...
	mlx = game->mlx_ptr;
	game->ROCK = ft_new_sprite(mlx, ROCK_XPM, game);
	game->GRASS = ft_new_sprite(mlx, GRASS_XPM, game);
	game->POKEBALL = ft_new_sprite(mlx, POKEBALL_XPM, game);
